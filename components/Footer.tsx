...
const footerLinks = {
  ...
  Resources: ["Documentation", "API Reference", "Status", "Community", "Tutorials"],
...
export default function Footer() {
  return (
    <footer className="relative border-t border-[#1E1E2E] bg-[#0A0A0F] pt-16 pb-8 px-4 overflow-hidden">
      {/* Subtle glow */}
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 mb-14">
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs mb-6">
              The next-generation trading bot for crypto traders who demand
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg border border-[#1E1E2E] bg-[#0F0F1A] flex items-center justify-center text-gray-500 hover:text-white hover:border-blue-500/40 hover:bg-blue-500/10 transition-all duration-200"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="pt-8 border-t border-[#1E1E2E] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-600">
            © {new Date().getFullYear()} Mfinity Trading Bot. All rights reserved.
          </p>
